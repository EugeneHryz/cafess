        ...
        <div class="row no-gutters row-bordered row-border-light">
            ...
            <div class="col-3 d-flex align-items-start">
                <div class="nav flex-column nav-pills align-items-stretch" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#account-general" type="button"
                            role="tab" aria-selected="true">General</button>
                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#account-change-password" type="button"
                            role="tab" aria-selected="false">Change password</button>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="account-general" role="tabpanel">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/controller"
                            ...
                            <div class="card-body media d-flex align-items-center">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <img id="profileImage" src="${pageContext.request.contextPath}/content/no_profile_picture.png"
                                ...
                                <div class="media-body ms-4">
                                    ...
                                    <div class="text-muted small mt-1" id="text-light">Allowed JPG, GIF or PNG. Max size of 2MB</div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="card-body" style="width: 70%">
                            <form id="userDataForm" method="post" action="${pageContext.request.contextPath}/controller">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="surname" class="form-control" value="${sessionScope.user.surname}">
                                </div>
                    ...
                    <div class="tab-pane fade mb-3" id="account-change-password" role="tabpanel">
                        <div class="card-body">
